...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CreateMovieRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateMovieRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/response.MovieResponse"
                            }
                        }
                    },
                    "500": {
        ...
        "/api/movies/by-genre": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Género para filtrar",
                        "name": "genre",
                        "in": "query",
                        "required": true
                    },
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "type": "array",
                                    "items": {
                                        "$ref": "#/definitions/response.MoviePreviewResponse"
                                    }
                                },
                                "genre": {
                                    "type": "string"
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/response.MovieDetailResponse"
                        }
                    },
                    "400": {
                        "description": "ID inválido",
        ...
        "/api/movies/{id}/player": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Datos para reproductor",
                        "schema": {
                            "$ref": "#/definitions/response.MoviePlayerResponse"
                        }
                    },
                    "400": {
                        "description": "ID inválido",
    ...
    "definitions": {
        ...
        "response.MovieDetailResponse": {
            ...
            "properties": {
                "description": {
                    "description": "Descripción extendida de la película\nrequired: true\nexample: La saga de la familia Corleone, liderada por Vito Corleone y posteriormente por su hijo Michael.",
                    "type": "string"
                },
                "genre": {
                    "description": "Género principal de la película\nrequired: true\nexample: Crimen",
                    "type": "string"
                },
                "id": {
                    "description": "ID único de la película en formato string\nrequired: true\nexample: \"1\"",
                    "type": "string"
                },
                "image_url": {
                    "description": "URL de la imagen en alta calidad\nrequired: true\nexample: https://cloudinary.com/example/padrino_detail.jpg",
                    "type": "string"
                },
                "year": {
